...
CREATE TABLE IF NOT EXISTS entities (
    ...
    authorized_by_id        INTEGER REFERENCES entities(id),
...
CREATE TABLE IF NOT EXISTS entity_executives (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    entity_id       INTEGER NOT NULL REFERENCES entities(id),
    executive_name  TEXT NOT NULL,
    added_at        TEXT NOT NULL DEFAULT (datetime('now')),
    UNIQUE(entity_id, executive_name)
);
...
CREATE INDEX IF NOT EXISTS idx_executives_name ON entity_executives(executive_name);
