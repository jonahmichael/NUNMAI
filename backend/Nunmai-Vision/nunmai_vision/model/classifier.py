...
# Changed to a PyTorch-native Hugging Face model
...
class NunmaiVisionClassifier:
    """
    Loads the pretrained lightweight deepfake classifier ONCE and reuses it for many predictions.
    Instantiate this ONCE at API startup, not per-request.
    """

    def __init__(self, model_name: str = MODEL_NAME):
        print(f"Loading pretrained lightweight model '{model_name}' (first run downloads weights)...")
