        ...
        Returns:
            {
                ...
                "risk_tier": "SAFE" | "SUSPICIOUS" | "PHISHING",
                "prediction": "phishing" | "legitimate",
                "top_risk_signals": [ (feature_name, raw_value), ... ],
                "top_trust_signals": [ (feature_name, raw_value), ... ],
                "sender_verification": {"verified": bool, "entity_name": str|None, "domain_checked": str},
                "raw_features": { "url": {...}, "header": {...}, "text": {...} },
            }
        """
